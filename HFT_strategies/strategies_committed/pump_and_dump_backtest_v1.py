...
if __name__ == '__main__':
    ...
    for i in range(1,31):
        ...
        check = []
        temp = s
        while l < len(df_date) - 200:
            print(l)
            bid_price = df_date[l:l + 200]["bid_price"]
            ask_price = df_date[l:l + 200]["ask_price"]
            ...
            if detect == "pump and dump":
                ...
                if len(dump) == len(pump_and_dump) and l < len(df_date) - 1000 and (s - temp < 2 or s-temp > -2):
